...
setwd("C:\Users\Yalap\Documents\Cours\M2 TIDE\Stage_remise_a_niveau\R\Projet\ShinyApp")

df <- read.csv("C:\Users\Yalap\Documents\Cours\M2 TIDE\Stage_remise_a_niveau\R\Projet\ShinyApp\data")
